...
RELEASE_TAG="20260310.05" #This is the release tag name while publishing to GitHub "releases" section
ZIP_NAME="steply-20260310.05-no-jre.zip" #This is the exact zip file name in the GitHub "releases" section.
